      ...
      <div className="space-y-6 pb-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 2xl:grid-cols-6 gap-3">
          ...
          <div
            ...
            className={`bg-white rounded-2xl p-3.5 min-w-0.5 border transition-all cursor-pointer ${
              statusFilter === 'all' ? 'border-[#1B2A6B] shadow-sm ring-1 ring-[#1B2A6B]/20' : 'border-slate-200/80 hover:border-slate-300'
            }`}
          >
            <div className="flex items-center justify-between mb-2">
              <span className="text-[11px] font-black uppercase tracking-wider text-slate-700">Total Tasks</span>
          ...
          <div
            ...
            className={`bg-white rounded-2xl p-3.5 min-w-0.5 border transition-all cursor-pointer ${
              statusFilter === 'in_progress' ? 'border-blue-600 shadow-sm ring-1 ring-blue-500/20' : 'border-slate-200/80 hover:border-slate-300'
            }`}
          >
            <div className="flex items-center justify-between mb-2">
              <span className="text-[11px] font-black uppercase tracking-wider text-slate-700">In Progress</span>
          ...
          {/* Card 3: Review Required (Purple Outline Badge) */}
          <div
            onClick={() => setStatusFilter('submitted')}
            className={`bg-white rounded-2xl p-3.5 min-w-0.5 border-2 transition-all cursor-pointer ${
              statusFilter === 'submitted'
                ? 'border-[#7C3AED] shadow-md ring-2 ring-[#7C3AED]/20 bg-purple-50/10'
                : 'border-purple-200 hover:border-purple-300'
            }`}
          >
            <div className="flex items-center justify-between mb-2">
              <span className="text-[11px] font-black uppercase tracking-wider text-purple-900">Review Required</span>
          ...
          <div
            ...
            className={`bg-white rounded-2xl p-3.5 min-w-0.5 border transition-all cursor-pointer ${
              statusFilter === 'changes_required' ? 'border-amber-500 shadow-sm ring-1 ring-amber-500/20' : 'border-amber-200/80 hover:border-amber-300'
            }`}
          >
            <div className="flex items-center justify-between mb-2">
              <span className="text-[11px] font-black uppercase tracking-wider text-amber-900">Needs Revision</span>
              <div className="w-6 h-6 rounded-lg bg-amber-50 text-amber-600 flex items-center justify-center">
                <RotateCcw size={12} />
              </div>
            </div>
            <div className="text-2xl font-black text-amber-600">{stats?.changes_required ?? 0}</div>
            <div className="flex items-center justify-between mt-2 pt-2 border-t border-amber-100 text-[10px] text-amber-700 font-bold">
          ...
          <div
            ...
            className={`bg-white rounded-2xl p-3.5 min-w-0.5 border transition-all cursor-pointer ${
              statusFilter === 'completed' ? 'border-emerald-600 shadow-sm ring-1 ring-emerald-500/20' : 'border-emerald-200/80 hover:border-emerald-300'
            }`}
          >
            <div className="flex items-center justify-between mb-2">
              <span className="text-[11px] font-black uppercase tracking-wider text-emerald-900">Approved & Scored</span>
              <div className="w-6 h-6 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center">
                <Award size={12} />
              </div>
            </div>
            <div className="text-2xl font-black text-emerald-600">{stats?.completed ?? 0}</div>
            <div className="flex items-center justify-between mt-2 pt-2 border-t border-emerald-100 text-[10px] text-emerald-700 font-bold">
          ...
          <div
            ...
            className={`bg-white rounded-2xl p-3.5 min-w-0.5 border transition-all cursor-pointer ${
              statusFilter === 'overdue' ? 'border-rose-600 shadow-sm ring-1 ring-rose-500/20' : 'border-rose-200/80 hover:border-rose-300'
            }`}
          >
            <div className="flex items-center justify-between mb-2">
              <span className="text-[11px] font-black uppercase tracking-wider text-rose-900">Overdue</span>
              <div className="w-6 h-6 rounded-lg bg-rose-50 text-rose-600 flex items-center justify-center">
                <AlertTriangle size={12} />
              </div>
            </div>
            <div className="text-2xl font-black text-rose-600">{stats?.overdue ?? 0}</div>
            <div className="flex items-center justify-between mt-2 pt-2 border-t border-rose-100 text-[10px] text-rose-700 font-bold">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-1 bg-slate-100 p-1 rounded-xl">
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                  activeTab === 'assigned_by_me' ? 'bg-white text-slate-900 shadow-xs' : 'text-slate-500 hover:text-slate-800'
                }`}
              >
                Assigned by Me
              </button>
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                  activeTab === 'my_tasks' ? 'bg-white text-slate-900 shadow-xs' : 'text-slate-500 hover:text-slate-800'
                }`}
              >
                My Tasks
              </button>
