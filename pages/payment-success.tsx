...
export default function PaymentSuccessPage() {
  ...
  return (
    <MainLayout>
      <div className="bg-gradient-to-b from-slate-50 via-slate-100/60 to-slate-50 text-slate-800 min-h-screen pt-28 pb-24 flex items-center justify-center relative overflow-hidden print:min-h-0 print:pt-0 print:pb-0 print:bg-white print:block">
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-2xl relative z-10 print:max-w-full print:p-0 print:m-0">
          <AnimatedContent direction="up" delay={0.1}>
            <div className="bg-white rounded-3xl border border-slate-200/80 p-8 md:p-12 shadow-[0_20px_50px_rgba(13,22,53,0.06)] text-center print-receipt-card print:p-6 print:border print:border-slate-200 print:shadow-none">
              
              {/* Print Only Header Logo */}
              <div className="hidden print:flex items-center justify-between border-b-2 border-[#1B2A6B] pb-3 mb-4 text-left">
                <div>
              ...
              {/* Success Badge Icon */}
              <div className="relative w-20 h-20 md:w-24 md:h-24 mx-auto mb-4 md:mb-6 print:mb-3 flex items-center justify-center">
                <motion.div 
                  animate={{ scale: [1, 1.18, 1] }} 
                  transition={{ duration: 2, repeat: Infinity }}
                  className="absolute inset-0 bg-emerald-400/20 rounded-full blur-md no-print" 
                />
                <div className="w-16 h-16 md:w-20 md:h-20 bg-gradient-to-tr from-emerald-500 to-teal-400 rounded-full flex items-center justify-center shadow-lg shadow-emerald-500/25 relative z-10">
                  <CheckCircle2 size={38} className="text-white" />
                </div>
              </div>
              
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs font-black uppercase tracking-wider mb-3 md:mb-4 print:mb-2 shadow-xs">
                <Sparkles size={14} className="text-[#C9A227]" /> Payment Confirmed & Access Granted
              </div>

              <h1 className="text-2xl md:text-4xl font-black text-[#0d1635] mb-2 md:mb-3 tracking-tight print:text-2xl print:mb-1">
                Payment Successful!
              </h1>
              <p className="text-slate-600 text-xs md:text-base max-w-lg mx-auto mb-6 md:mb-8 print:mb-4 font-medium leading-relaxed">
              ...
              {/* Order Receipt Card */}
              <div className="bg-slate-50/80 rounded-2xl p-5 md:p-6 mb-6 md:mb-8 print:mb-4 print:p-4 border border-slate-200 text-left space-y-3 md:space-y-4 shadow-xs">
                {service && (
                  <div className="pb-2.5 border-b border-slate-200/80">
                    <span className="text-xs font-bold text-slate-400 uppercase tracking-wider block mb-0.5">Item / Session</span>
                ...
                <div className="grid grid-cols-2 gap-3 md:gap-4 pb-2.5 border-b border-slate-200/80">
                  <div>
                  ...
                  <div>
                    <span className="text-xs font-bold text-slate-400 uppercase tracking-wider block mb-0.5">Amount Paid</span>
              ...
              {/* Next Steps Card */}
              <div className="bg-blue-50/60 rounded-2xl p-4 md:p-5 mb-6 md:mb-8 print:mb-0 print:p-3.5 border border-blue-100 text-left">
                <h4 className="text-xs font-black uppercase tracking-wider text-[#0d1635] mb-1.5 flex items-center gap-1.5">
                  <UserCheck size={16} className="text-blue-600" /> What Happens Next?
                </h4>
                <ul className="text-xs font-medium text-slate-600 space-y-1 list-disc list-inside">
              ...
              {/* Action Buttons */}
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 no-print print:hidden">
                <button 
              ...
              {/* Need Help Footer */}
              <div className="mt-8 pt-6 border-t border-slate-100 flex justify-between items-center text-xs text-slate-500 font-semibold no-print print:hidden">
