...
export default function JobsPage() {
  ...
  // savedIds = set of job IDs saved in DB
  ...
  return (
    <StudentDashboardLayout>
      <div className="mb-8">
        <h1 className="text-2xl font-black text-slate-800 mb-1">Jobs</h1>
        <p className="text-slate-500 text-sm font-medium">Discover full-time roles matched to your profile and skills.</p>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="space-y-1.5 mb-4 text-xs text-slate-500 font-semibold">
                  ...
                  <div className="flex items-center gap-1.5"><IndianRupee size={11} className="shrink-0" /> <span>{item.salary || 'Unpaid'}</span></div>
                </div>
