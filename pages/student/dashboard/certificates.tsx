              ...
              <Card key={cert.id} className="hover:border-slate-300 transition-all overflow-hidden group">
                ...
                <CardContent className="p-4 bg-white">
                  ...
                  <div className="flex gap-2">
                    <a href={`${process.env.NEXT_PUBLIC_API_URL || 'https://backend.blueboxx.in/api'}/public/certificates/${cert.certificate_number}/download`} target="_blank" rel="noreferrer" className="flex-1">
